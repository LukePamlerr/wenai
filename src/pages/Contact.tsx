    ...
    <div className="pt-32 pb-24 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-24 text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-brand-white mb-6">Partner With Overtime</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
          <div className="space-y-12">
            <div className="flex gap-6 items-start group">
              <div className="p-4 rounded-2xl bg-brand-grey-light text-brand-white group-hover:scale-110 transition-transform">
                <Zap size={24} />
              </div>
              <div>
                <h3 className="text-xl font-bold text-brand-white mb-2">What We Do</h3>
            ...
            <div className="flex gap-6 items-start group">
              ...
              <div>
                <h3 className="text-xl font-bold text-brand-white mb-2">Hire Us</h3>
                <p className="text-brand-grey leading-relaxed">
            ...
            <div className="flex gap-6 items-start group">
              ...
              <div>
                <h3 className="text-xl font-bold text-brand-white mb-2">Game Acquisitions</h3>
                <p className="text-brand-grey leading-relaxed">
            ...
            <div className="flex gap-6 items-start group pt-6 border-t border-brand-grey/10">
              <div className="p-4 rounded-2xl bg-brand-white text-brand-black group-hover:scale-110 transition-transform">
                <Mail size={24} />
              </div>
              <div>
                <h3 className="text-xl font-bold text-brand-white mb-2">Direct Contact</h3>
                <a href="mailto:contact@overtime.org" className="text-brand-white font-bold hover:text-brand-grey transition-colors text-lg">contact@overtime.org</a>
                <div className="mt-2 flex gap-4">
                  <a href="#" className="text-brand-grey hover:text-brand-white transition-colors flex items-center gap-1 text-sm">
          ...
          <div className="p-12 rounded-[3rem] bg-brand-grey-light border border-brand-grey/10 shadow-2xl relative overflow-hidden">
            {formState === 'sent' ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-24">
                ...
                <h3 className="text-3xl font-bold text-brand-white mb-4">Message Sent!</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                ...
                <div className="p-4 rounded-2xl bg-brand-grey-light/50 border border-brand-grey/10 text-sm text-brand-grey">
                  Looking to join the team? <Link to="/apply" className="text-brand-white font-bold hover:underline">Apply here</Link> instead.
                </div>
